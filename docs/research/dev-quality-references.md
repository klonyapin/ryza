...
- レビュー技法: インスペクション(Fagan 1976, IBM Systems Journal: 発見誤りの82%・総開発コスト25-30%削減 — 50年前の IBM 環境の値であり現代環境への直接適用は不可と付記)〜モダンコードレビュー(パスアラウンド型)の体系。[整理](https://qiita.com/mkt_hanada/items/4a6c16800ed061111233)
...
4. AI 固有: エージェント実装→独立審査(インスペクション相当)→是正→統合のループを標準プロセス化し、審査意見書の保存(docs/reviews)と指摘メトリクスの蓄積を義務化
