...
- 更新日: 2026-08-02
- 図入り版(レビュー用): https://claude.ai/code/artifact/920bd833-2a95-4a19-bd3b-0c1a21b4e9e4
- 根拠資料: `docs/research/` の5本
...
| 部門 | 責務 | 成果物 | サイクル |
|---|---|---|---|
| 投資委員会(=ユーザー) | IPS・政策・予算・戦略昇格・PR・監査対応の承認。緊急停止 | 承認/却下(監査ログ) | 随時 |
